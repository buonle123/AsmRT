...
const PaymentScreen = ({ navigation, route }: any) => {
  ...
  return (
    <View style={styles.ScreenContainer}>
              ...
              <View style={styles.CreditCardBG}>
                <LinearGradient start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} colors={[COLORS.primaryGreyHex, COLORS.primaryBlackHex]} style={styles.LinearGradientStyle}>
                  ...
                  <View style={styles.CreditCardNumberContainer}>
                    ...
                    <Text style={styles.CreditCardNumber}>9237</Text>
                    <Text style={styles.CreditCardNumber}>6447</Text>
                    <Text style={styles.CreditCardNumber}>4564</Text>
                  </View>
                  <View style={styles.CreditCardRow}>
      ...
      <PaymentFooter buttonTitle={`Pay with ${paymentMode}`} price={{ price: route.params.amount, currency: '$' }} buttonPressHandler={() => {
        buttonPressHanlder()
      }} />
    </View>
  )

...
export const useStore = create(
    persist(
        (set, get) => ({
            ...
            addToFavotiteList: (type: string, id: string) => set(produce(state => {
                if (type === 'Coffee') {
            ...
            addToOrderHistoryListFromCart: () => set(produce(state => {
                let totalPrice = state.CartList.reduce((sumPrice: number, currentValue: any) => {
                    return sumPrice + parseFloat(currentValue.ItemPrice)
                }, 0)
